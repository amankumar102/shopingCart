...
import { add, remove } from '../redux/slices/CartSlice'; // Adjust the path as needed
...
function Product({ post }) {
    ...
    return (
        <div className='flex flex-col items-center justify-between shadow-md
        hover:scale-110 hover:shadow-2xl transition duration-300 ease-in gap-3 p-4 mt-5 rounded-2xl'>
            <div>
